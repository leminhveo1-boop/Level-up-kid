...
export default function BossPage() {
  ...
  const handleOpenChest = () => {
    ...
    alert(`🎉 Chúc mừng Chiến Binh ${charName} đã mở Rương Kho Báu Mùa Hè! Bố mẹ sẽ thưởng cho con một món quà đặc biệt ngày hôm nay! Hãy chụp màn hình này gửi cho bố mẹ nhé!`);
  };
